...
# ===== MAGIC 代理引擎（图像生成） =====
IMAGES_MAGIC_API_BASE_URL = os.getenv('IMAGES_MAGIC_API_BASE_URL', '')

IMAGES_MAGIC_API_KEY = os.getenv('IMAGES_MAGIC_API_KEY', '')
...
# ===== MAGIC 代理引擎（图像编辑） =====
IMAGES_EDIT_MAGIC_API_BASE_URL = os.getenv('IMAGES_EDIT_MAGIC_API_BASE_URL', '')

IMAGES_EDIT_MAGIC_API_KEY = os.getenv('IMAGES_EDIT_MAGIC_API_KEY', '')
...
IMAGE_PROMPT_GENERATION_MODEL_EXTERNAL = os.getenv('IMAGE_PROMPT_GENERATION_MODEL_EXTERNAL', '')
...
DEFAULT_CONFIG = {
    ...
    'image_generation.magic.api_base_url': IMAGES_MAGIC_API_BASE_URL,
    'image_generation.magic.api_key': IMAGES_MAGIC_API_KEY,
    ...
    'images.edit.magic.api_base_url': IMAGES_EDIT_MAGIC_API_BASE_URL,
    'images.edit.magic.api_key': IMAGES_EDIT_MAGIC_API_KEY,
    ...
    'task.image_prompt.model.external': IMAGE_PROMPT_GENERATION_MODEL_EXTERNAL,
