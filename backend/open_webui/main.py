...
# MAGIC proxy image
app.state.config.IMAGES_MAGIC_API_BASE_URL = IMAGES_MAGIC_API_BASE_URL
app.state.config.IMAGES_MAGIC_API_KEY = IMAGES_MAGIC_API_KEY
...
# MAGIC proxy edit
app.state.config.IMAGES_EDIT_MAGIC_API_BASE_URL = IMAGES_EDIT_MAGIC_API_BASE_URL
app.state.config.IMAGES_EDIT_MAGIC_API_KEY = IMAGES_EDIT_MAGIC_API_KEY
...
app.state.config.IMAGE_PROMPT_GENERATION_MODEL_EXTERNAL = IMAGE_PROMPT_GENERATION_MODEL_EXTERNAL
